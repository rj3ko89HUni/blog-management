    ...
    <div id="home" class="big-img">
      ...
      <div class="all">
           ...
           <div id="nav-content">
             <nav>
               <ul class="Side-bar">
                 ...
                 <li><a href="../views/admin/blog/today/trend.blade.php">Trend</a></li>
                 <li><a href="../views/admin/blog/today/update.blade.php">Update</a></li>
                 ...
                 <ul class="ac">
                   <li>
                     ...
                     <div class="ac-content">
                       <p><a href="../views/admin/blog/bloger/folder.blade.php">マナブ</a></p>
                       <p><a href="../views/admin/blog/bloger/folder.blade.php">マナブ</a></p>
                     </div>
                   </li>
                 </ul>
                 ...
                 <li><a href="../views/admin/blog/keep/read_later.blade.php">Read Later</a></li>
                 <li><a href="../views/admin/blog/keep/history_site.blade.php">History</a></li>
                 <li><a href="../views/admin/blog/keep/memo.blade.php">Memo</a></li>
               </ul>
             </nav>
           </div>
        </div>
        ...
        <div class="main">
          ...
          <li class="good">マナブ</li>
        　<div class="contentss">
           <div class="contentsss">
             <p class="preservation">2022-3/20</p>
          　　<div class="card-contents">
            ...
            <div class="contentsss">
              <p class="preservation">2022-3/19</p>
              <div class="card-contents">
                <div class="list-area">
                  <div class="Buroger-list">
            ...
            <div class="contentsss">
              <p class="preservation">2022-3/18</p>
              <div class="card-contents">
                <div class="list-area">
                  <div class="Buroger-list">
